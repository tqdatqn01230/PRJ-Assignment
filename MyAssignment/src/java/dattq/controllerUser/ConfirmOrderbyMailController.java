...
import dattq.sendfile.Entry;

/**
 *
 * @author Dell
 */
@WebServlet(name = "ConfirmOrderbyMailController", urlPatterns = {"/ConfirmOrderbyMailController"})
public class ConfirmOrderbyMailController extends HttpServlet {
