...
public class LoginController extends HttpServlet {
     ...
     */
    protected final String SUCCESS1="search.jsp";
    protected final String SUCCESS2="ShoppingCartController";
    protected final String ERROR="login.jsp";
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if (user!=null){
                if ("AD".equals(user.getRole())) url=SUCCESS1;
                else url=SUCCESS2;
